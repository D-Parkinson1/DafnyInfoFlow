  ...
  public class DafnyOptions : Bpl.CommandLineOptions {
    ...
    protected override bool ParseOption(string name, Bpl.CommandLineOptionEngine.CommandLineParseState ps) {
      ...
      switch (name) {
        case "infoFlow":
          int inject = 0;
          if (ps.GetNumericArgument(ref inject, 3)) {
...
/infoFlow:<n>
    0 - (default) do not add information flow analysis assertions
    1 - Add information flow analysis boilerplate for the user to fill in. Print to the first given input file
    2 - Add information flow analysis assertions. Print results to the console
/dprelude:<file>
